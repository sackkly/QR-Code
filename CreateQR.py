...
#Row1
Label(bg='white',width=90,height=23,compound=LEFT).grid(row=1,column=0,padx=(0,0),pady=(0,20))
Label(bg='#e1f5fe',text= "Vendor",font=("Tahoma",12),compound=LEFT).grid(row=0,column=0,padx=(0,0),pady=(0,20))
